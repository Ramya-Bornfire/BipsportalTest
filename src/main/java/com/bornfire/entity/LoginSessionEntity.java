...
public class LoginSessionEntity {
	...
	public LoginSessionEntity(String session_id, String merchant_id, String user_id, String unit_id, Date login_date,
			Date last_active_date, String session_status, String ip_address, String device_id, String device_type,
			String os_version, String app_version, String session_token, BigDecimal failed_attempts, String failure_reason) {
		super();
		this.session_id = session_id;
		this.merchant_id = merchant_id;
		this.user_id = user_id;
	...
	public String toString() {
		return "LoginSessionEntity [session_id=" + session_id + ", merchant_id=" + merchant_id + ", user_id=" + user_id
				+ ", unit_id=" + unit_id + ", login_date=" + login_date + ", last_active_date=" + last_active_date
