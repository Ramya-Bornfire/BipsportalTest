...
@Entity
@Table(name = "Static_Merchant_Notification_History")
public class StaticMerchantNotificationHistoryEntity {
	 @Id
		...
		public StaticMerchantNotificationHistoryEntity(String notification_id, String merchant_id, String user_id,
		...
		public StaticMerchantNotificationHistoryEntity() {
			super();
