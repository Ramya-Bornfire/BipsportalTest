...
public class MerchantMasterMod {
	...
	public MerchantMasterMod(String merchant_id, String merchant_pow_ca_no, String merchant_acc_no,
			...
			String send_notifi_r8, String send_notifi_r9, String send_notifi_r10, String ph_countrycode_r1,
			String ph_countrycode_r2, String ph_countrycode_r3, String ph_countrycode_r4, String ph_countrycode_r5,
			String ph_countrycode_r6, String ph_countrycode_r7, String ph_countrycode_r8, String ph_countrycode_r9,
			String ph_countrycode_r10, String ofc_countrycode_r1, String ofc_countrycode_r2, String ofc_countrycode_r3,
			String ofc_countrycode_r4, String ofc_countrycode_r5, String ofc_countrycode_r6, String ofc_countrycode_r7,
			String ofc_countrycode_r8, String ofc_countrycode_r9, String ofc_countrycode_r10, String bank_name2,
			String bank_account_no2, String bank_branch2, String bank_code2, String iban2, String currency2,
			String settlement_frequency2, String settlement_day2, String settlement_date2, BigDecimal chargeback_amount,
			String chargeback_approval, byte[] photo, String transaction_amount,String detailed_address1,String detailed_address2) {
		super();
		this.detailed_address1=detailed_address1;
		this.detailed_address2=detailed_address2;
		this.merchant_id = merchant_id;
	...
	public String toString() {
		return "MerchantMasterMod [merchant_id=" + merchant_id + ", merchant_pow_ca_no=" + merchant_pow_ca_no
				...
				+ send_notifi_r10 + ", ph_countrycode_r1=" + ph_countrycode_r1 + ", ph_countrycode_r2="
				...
				+ ofc_countrycode_r10 + ", bank_name2=" + bank_name2 + ", bank_account_no2=" + bank_account_no2
				...
				+ settlement_day2 + ", settlement_date2=" + settlement_date2 + ", chargeback_amount="
				+ chargeback_amount + ", chargeback_approval=" + chargeback_approval + ", photo="
				+ Arrays.toString(photo) + ", transaction_amount=" + transaction_amount + ", getTransaction_amount()="
				+ getTransaction_amount() + ", getPhoto()=" + Arrays.toString(getPhoto()) + ", getMer_user_id_r6()="
				+ getMer_user_id_r6() + ", getMer_user_id_r7()=" + getMer_user_id_r7() + ", getMer_user_id_r8()="
				+ getMer_user_id_r8() + ", getMer_user_id_r9()=" + getMer_user_id_r9() + ", getMer_user_id_r10()="
				+ getMer_user_id_r10() + ", getMer_cont_pers_r6()=" + getMer_cont_pers_r6() + ", getMer_cont_pers_r7()="
				+ getMer_cont_pers_r7() + ", getMer_cont_pers_r8()=" + getMer_cont_pers_r8()
				+ ", getMer_cont_pers_r9()=" + getMer_cont_pers_r9() + ", getMer_cont_pers_r10()="
				+ getMer_cont_pers_r10() + ", getMer_ph_no_r6()=" + getMer_ph_no_r6() + ", getMer_ph_no_r7()="
				+ getMer_ph_no_r7() + ", getMer_ph_no_r8()=" + getMer_ph_no_r8() + ", getMer_ph_no_r9()="
				+ getMer_ph_no_r9() + ", getMer_ph_no_r10()=" + getMer_ph_no_r10() + ", getMer_ofc_no_r6()="
				+ getMer_ofc_no_r6() + ", getMer_ofc_no_r7()=" + getMer_ofc_no_r7() + ", getMer_ofc_no_r8()="
				+ getMer_ofc_no_r8() + ", getMer_ofc_no_r9()=" + getMer_ofc_no_r9() + ", getMer_ofc_no_r10()="
				+ getMer_ofc_no_r10() + ", getMer_email_addr_r6()=" + getMer_email_addr_r6()
				+ ", getMer_email_addr_r7()=" + getMer_email_addr_r7() + ", getMer_email_addr_r8()="
				+ getMer_email_addr_r8() + ", getMer_email_addr_r9()=" + getMer_email_addr_r9()
				+ ", getMer_email_addr_r10()=" + getMer_email_addr_r10() + ", getMer_notifi_mode_r6()="
				+ getMer_notifi_mode_r6() + ", getMer_notifi_mode_r7()=" + getMer_notifi_mode_r7()
				+ ", getMer_notifi_mode_r8()=" + getMer_notifi_mode_r8() + ", getMer_notifi_mode_r9()="
				+ getMer_notifi_mode_r9() + ", getMer_notifi_mode_r10()=" + getMer_notifi_mode_r10()
				+ ", getSend_notifi_r6()=" + getSend_notifi_r6() + ", getSend_notifi_r7()=" + getSend_notifi_r7()
				+ ", getSend_notifi_r8()=" + getSend_notifi_r8() + ", getSend_notifi_r9()=" + getSend_notifi_r9()
				+ ", getSend_notifi_r10()=" + getSend_notifi_r10() + ", getPh_countrycode_r1()="
				...
				+ ", getChargeback_amount()=" + getChargeback_amount() + ", getChargeback_approval()="
				+ getChargeback_approval() + ", getMerchant_id()=" + getMerchant_id() + ", getMerchant_pow_ca_no()="
				+ getMerchant_pow_ca_no() + ", getMerchant_acc_no()=" + getMerchant_acc_no() + ", getMerchant_addr()="
				+ getMerchant_addr() + ", getMerchant_legal_id()=" + getMerchant_legal_id()
				+ ", getMerchant_cont_per()=" + getMerchant_cont_per() + ", getMerchant_name()=" + getMerchant_name()
