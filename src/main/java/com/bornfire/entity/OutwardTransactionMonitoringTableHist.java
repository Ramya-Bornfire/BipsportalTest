...
@Entity
@Table(name = "BIPS_OUTWARD_TRANSACTION_HIST_MONITORING_TABLE")
public class OutwardTransactionMonitoringTableHist {
	...
	public OutwardTransactionMonitoringTableHist(String akg_desc, String akg_status, Date akg_time, Date auth_time,
			...
			String unit_name, String user_id, String user_ref, Date value_date, String user_name) {
		super();
		this.akg_desc = akg_desc;
		this.akg_status = akg_status;
		this.akg_time = akg_time;
	...
	public OutwardTransactionMonitoringTableHist() {
		super();
		// TODO Auto-generated constructor stub
	}

	public OutwardTransactionMonitoringTableHist(OutwardTransactionMonitoringTable outEntity) {
		...
		this.user_name=outEntity.getUser_name();
	}
